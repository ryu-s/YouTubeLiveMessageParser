...
namespace YouTubeLiveSitePluginTests
{
    public class ActionParseTests
    {
        ...
        {
            var raw = "{\"addChatItemAction\":{\"item\":{\"liveChatModerationMessageRenderer\":{\"message\":{\"runs\":[{\"text\":\"abc\",\"bold\":true,\"italics\":true},{\"text\":\" さんは \",\"italics\":true},{\"text\":\"xyz\",\"bold\":true,\"italics\":true},{\"text\":\" さんから \",\"italics\":true},{\"text\":\"300\",\"italics\":true},{\"text\":\" 秒間のタイムアウト措置を受けました。\",\"italics\":true}]},\"id\":\"ChwKGkNNbkNuT0RO0ZSbkR3Z1FkaFljREl3\",\"timestampUsec\":\"1636540850053483\"}}}}";
            var a = ActionFactory.Parse(raw);
            if (a is not LiveChatModerationMessage moderation)
            {
                Assert.Fail();
                return;
            }
        ...
        [Test]
        public void ParseUpdateLiveChatPollActionTest()
        {
            var raw = "{\"updateLiveChatPollAction\":{\"pollToUpdate\":{\"pollRenderer\":{\"choices\":[{\"text\":{\"runs\":[{\"text\":\"ポルターガイスト（14歳JC)\"}]},\"selected\":false,\"voteRatio\":0.5,\"votePercentage\":{\"simpleText\":\"50%\"},\"selectServiceEndpoint\":{\"commandMetadata\":{\"webCommandMetadata\":{\"sendPost\":true,\"apiUrl\":\"/youtubei/v1/live_chat/send_live_chat_vote\"}},\"sendLiveChatVoteEndpoint\":{\"params\":\"Q2lrcUp3b1lWVU5QT1cxcFZ6UkdkbmQ1VG10aFdsQndTbGxOUjNaQkVndDFhSEZpUjJKM1lsWkpSUkliQ2hrS0YzZHdVMHhaWmtOa1Qwc3liblJQVlZCcGMzazBjMEZGSWdBcUdnb1lWVU5QT1cxcFZ6UkdkbmQ1VG10aFdsQndTbGxOUjNaQk1BSTRCRUFC\"}}},{\"text\":{\"runs\":[{\"text\":\"デーモン（28歳人妻）\"}]},\"selected\":false,\"voteRatio\":0,\"votePercentage\":{\"simpleText\":\"0%\"},\"selectServiceEndpoint\":{\"commandMetadata\":{\"webCommandMetadata\":{\"sendPost\":true,\"apiUrl\":\"/youtubei/v1/live_chat/send_live_chat_vote\"}},\"sendLiveChatVoteEndpoint\":{\"params\":\"Q2lrcUp3b1lWVU5QT1cxcFZ6UkdkbmQ1VG10aFdsQndTbGxOUjNaQkVndDFhSEZpUjJKM1lsWkpSUkliQ2hrS0YzZHdVMHhaWmtOa1Qwc3liblJQVlZCcGMzazBjMEZGSWdJSUFTb2FDaGhWUTA4NWJXbFhORVoyZDNsT2EyRmFVSEJLV1UxSGRrRXdBamdFUUFFJTNE\"}}},{\"text\":{\"runs\":[{\"text\":\"マイリング（20歳JD）\"}]},\"selected\":false,\"voteRatio\":0.5,\"votePercentage\":{\"simpleText\":\"50%\"},\"selectServiceEndpoint\":{\"commandMetadata\":{\"webCommandMetadata\":{\"sendPost\":true,\"apiUrl\":\"/youtubei/v1/live_chat/send_live_chat_vote\"}},\"sendLiveChatVoteEndpoint\":{\"params\":\"Q2lrcUp3b1lWVU5QT1cxcFZ6UkdkbmQ1VG10aFdsQndTbGxOUjNaQkVndDFhSEZpUjJKM1lsWkpSUkliQ2hrS0YzZHdVMHhaWmtOa1Qwc3liblJQVlZCcGMzazBjMEZGSWdJSUFpb2FDaGhWUTA4NWJXbFhORVoyZDNsT2EyRmFVSEJLV1UxSGRrRXdBamdFUUFFJTNE\"}}}],\"liveChatPollId\":\"ChkKF3dwU0xZZkNkT0sybnRPVVBpc3k0c0FF\",\"header\":{\"pollHeaderRenderer\":{\"pollQuestion\":{\"runs\":[{\"text\":\"結婚するならどれ？\"}]},\"thumbnail\":{\"thumbnails\":[{\"url\":\"https://yt4.ggpht.com/JERe83w3Rk7V7GmSFoTKVxs8AsOf0YkXYMn4At75TOi0qJFjLteKF52AO0Cq9EgoaZwh2824=s32-c-k-c0x00ffffff-no-rj\",\"width\":32,\"height\":32},{\"url\":\"https://yt4.ggpht.com/JERe83w3Rk7V7GmSFoTKVxs8AsOf0YkXYMn4At75TOi0qJFjLteKF52AO0Cq9EgoaZwh2824=s64-c-k-c0x00ffffff-no-rj\",\"width\":64,\"height\":64}]},\"metadataText\":{\"runs\":[{\"text\":\"みるくたん\"},{\"text\":\" ? \"},{\"text\":\"たった今\"},{\"text\":\" ? \"},{\"text\":\"2 票\"}]},\"liveChatPollType\":\"LIVE_CHAT_POLL_TYPE_CREATOR\",\"contextMenuButton\":{\"buttonRenderer\":{\"icon\":{\"iconType\":\"MORE_VERT\"},\"accessibilityData\":{\"accessibilityData\":{\"label\":\"コメントの操作\"}},\"targetId\":\"live-chat-action-panel-poll-context-menu\",\"command\":{\"commandMetadata\":{\"webCommandMetadata\":{\"ignoreNavigation\":true}},\"liveChatItemContextMenuEndpoint\":{\"params\":\"Q2hzS0dRb1hkM0JUVEZsbVEyUlBTekp1ZEU5VlVHbHplVFJ6UVVVYUtTb25DaGhWUTA4NWJXbFhORVoyZDNsT2EyRmFVSEJLV1UxSGRrRVNDM1ZvY1dKSFluZGlWa2xGSUFJb0JESWFDaGhWUTA4NWJXbFhORVoyZDNsT2EyRmFVSEJLV1UxSGRrRTRBUSUzRCUzRA==\"}}}}}},\"displayVoteResults\":true,\"button\":{\"buttonRenderer\":{\"style\":\"STYLE_BLACK\",\"size\":\"SIZE_DEFAULT\",\"isDisabled\":false,\"text\":{\"simpleText\":\"アンケートを終了する\"},\"accessibilityData\":{\"accessibilityData\":{\"label\":\"アンケートを終了する\"}},\"command\":{\"commandMetadata\":{\"webCommandMetadata\":{\"sendPost\":true,\"apiUrl\":\"/youtubei/v1/live_chat/live_chat_action\"}},\"liveChatActionEndpoint\":{\"params\":\"\"}}}}}}}}";
            var a = ActionFactory.Parse(raw);
            if (a is not UpdateLiveChatPollAction autoMod)
            {
                Assert.Fail();
                return;
            }
        ...
        [Test]
        public void ParseShowLiveChatDialogActionTest()
        {
            var raw = "{\"clickTrackingParams\":\"CAEQl98BIhMI-4WHpr2M9AIVBBhgCh3zZArI\",\"showLiveChatDialogAction\":{\"dialog\":{\"upsellDialogRenderer\":{\"title\":\"あなたの書いた内容は誰でも見ることができることを忘れないでください\",\"trackingParams\":\"CA0QnZYIIhMI-4WHpr2M9AIVBBhgCh3zZArI\",\"headerBackgroundImage\":{\"thumbnails\":[{\"url\":\"https://www.gstatic.com/youtube/img/aadc/mm_nitrate_darkmode_mweb_2-f2e57d180bb247c4084d0024921fae84.png\",\"width\":386,\"height\":240}]},\"dialogMessageTitle\":{\"runs\":[{\"text\":\"あなたの書いた内容は誰でも見ることができることを忘れないでください\"}]},\"dialogMessageText\":{\"runs\":[{\"text\":\"ご自身とコミュニティの安全を守るために、個人情報の共有を避け、YouTube の\"},{\"text\":\"コミュニティ ガイドライン\",\"navigationEndpoint\":{\"clickTrackingParams\":\"CA0QnZYIIhMI-4WHpr2M9AIVBBhgCh3zZArI\",\"commandMetadata\":{\"webCommandMetadata\":{\"url\":\"//support.google.com/youtube/answer/2853856?hl=ja#safe\",\"webPageType\":\"WEB_PAGE_TYPE_UNKNOWN\",\"rootVe\":83769}},\"urlEndpoint\":{\"url\":\"//support.google.com/youtube/answer/2853856?hl=ja#safe\",\"target\":\"TARGET_NEW_WINDOW\"}}},{\"text\":\"を遵守してください\"}]},\"dismissButton\":{\"buttonRenderer\":{\"style\":\"STYLE_BLUE_TEXT\",\"size\":\"SIZE_DEFAULT\",\"isDisabled\":false,\"text\":{\"simpleText\":\"OK\"},\"trackingParams\":\"CA4QnpYIIhMI-4WHpr2M9AIVBBhgCh3zZArI\",\"accessibilityData\":{\"accessibilityData\":{\"label\":\"OK\"}}}},\"isVisible\":true}}}}";
            var a = ActionFactory.Parse(raw);
            if (a is not IgnoredMessage ignored)
            {
                Assert.Fail();
        ...
        [Test]
        public void ParseCloseLiveChatActionPanelActionTest()
        {
            var raw = "{\"closeLiveChatActionPanelAction\":{\"targetPanelId\":\"ChkKF3dwU0xZZkNkT0sybnRPVVBpc3k0c0FF\",\"skipOnDismissCommand\":true}}";
            var a = ActionFactory.Parse(raw);
            if (a is not IgnoredMessage ignored)
            {
                Assert.Fail();
        ...
        [Test]
        public void ParseCommandMetadataTest()
        {
            var raw = "{\"clickTrackingParams\":\"CAEQl98BIhMI-4WHpr2M9AIVBBhgCh3zZArI\",\"commandMetadata\":{\"webCommandMetadata\":{\"sendPost\":true,\"apiUrl\":\"/youtubei/v1/comment/perform_comment_action\"}},\"performCommentActionEndpoint\":{\"action\":\"CBiCAgIgAQ%3D%3D\"}}";
            var a = ActionFactory.Parse(raw);
            if (a is not IgnoredMessage ignored)
            {
                Assert.Fail();
